...
const Herosection = () => {
  ...
  <AnimatePresence mode="wait">
    <motion.div
      ...
      className="max-w-7xl w-full px-6 md:px-16 
    ...
    >
      ...
      <div className="max-w-xl space-y-6 text-center md:text-left">
        ...
        <div className="flex items-center gap-6 justify-center md:justify-start">
          ...
          <button className="px-6 sm:px-7 py-3 rounded-xl bg-black text-white hover:bg-gray-800 transition-all duration-300">
            Shop Now
          </button>
        </div>
      </div>
      ...
      <motion.img
        src={product.image}
        alt={product.name}
        className="h-60 sm:h-72 md:h-96 object-contain drop-shadow-xl"
        initial={{ scale: 0.95 }}
        animate={{ scale: 1 }}
        transition={{ duration: 0.6 }}
      />
